...
//		 Số lượng tồn
		...
		lblpName.setPreferredSize(new Dimension(200,50));
		lblpPrice.setPreferredSize(new Dimension(200,50));
		lblpDep.setPreferredSize(new Dimension(200,50));
		lblpSize.setPreferredSize(new Dimension(200,50));
		lblpQuan.setPreferredSize(new Dimension(200,50));
...
//		 Size (ComboBox)
		...
		for(JButton btn :  new JButton[] {btnMinus, btnPlus, btnAddToCart}) {
			btn.setFont(fo);
			btn.addActionListener(proCtrl);
		}
