...
public class loginFrame extends JFrame {
	...
	public JLabel lb_forgotPassword;
	...
	public loginFrame() {
		...
		this.addWindowListener(logCtrl);
		...
		btn_dk.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		lb_forgotPassword = new JLabel("<html><u>Quên mật khẩu?</u></html>");
		lb_forgotPassword.setFont(font);
		lb_forgotPassword.addMouseListener(logCtrl);
		lb_forgotPassword.setForeground(Color.BLUE);
		lb_forgotPassword.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		b5.add(lb_forgotPassword);
		...
		pnl_login.add(Box.createVerticalStrut(20));
		pnl_login.add(b4);
		pnl_login.add(Box.createVerticalStrut(15));
		pnl_login.add(b5);
